import { entity } from '@cap-js/cds-types/apis/csn' // cyclic dependency
import { UnionToIntersection, UnionsToIntersections } from '@cap-js/cds-types/apis/internal/inference'
