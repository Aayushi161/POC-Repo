import { LinkedAssociation, LinkedEntity, linked } from '@cap-js/cds-types/apis/linked'
import * as csn from '@cap-js/cds-types/apis/csn'
import { service } from '@cap-js/cds-types/apis/server'
