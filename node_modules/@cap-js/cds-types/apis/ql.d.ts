import { Definition, EntityElements } from '@cap-js/cds-types/apis/csn'
import * as CQN from '@cap-js/cds-types/apis/cqn'
import { Constructable, ArrayConstructable, SingularType } from '@cap-js/cds-types/apis/internal/inference'
import { LinkedEntity } from '@cap-js/cds-types/apis/linked'
import { ref, column_expr } from '@cap-js/cds-types/apis/cqn'
