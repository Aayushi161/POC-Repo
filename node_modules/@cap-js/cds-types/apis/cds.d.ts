...
export * from '@cap-js/cds-types/apis/env'
...
export * from '@cap-js/cds-types/apis/utils'
export { log, debug } from '@cap-js/cds-types/apis/log'
export { test } from '@cap-js/cds-types/apis/test'
...
import * as ql from '@cap-js/cds-types/apis/ql'
export { ql }
export { QLExtensions } from '@cap-js/cds-types/apis/ql' // cds-ql.ts test tries to import this from top level? Correct? Or ql.QLExtensions?

// trick to work around "delete" as reserved identifier
import { Service } from '@cap-js/cds-types/apis/services'
